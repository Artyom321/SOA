...
// Handler представляет обработчик запросов API
type Handler struct {
...
// Создание прокси для направления запросов в сервис пользователей
...
// ProxyRequest перенаправляет запрос в сервис пользователей
